...
function bsHome() {
  const posts = [
    { n: 'Nikhil Bhai', verified: true, status: ['open','Open 24h'], dist: '1.6 km', cat: 'Services', area: 'Bandra · 400050', avatar: 'var(--b-grad)', img: 'linear-gradient(135deg,#2B1B5B,#7C3AED)', likes: 12, following: true, cap: '<b>Welcome to Nikhil Bhai!</b> 24x7 home services — plumbing, electrical, AC repair.' },
    { n: 'Sharma Electronics', verified: true, status: ['soon','Closes in 42m'], dist: '1.2 km', cat: 'Electronics', area: 'Andheri W · 400053', avatar: 'var(--b-grad-warm)', img: 'linear-gradient(135deg,#1A0B0B,#FF6B35)', likes: 87, following: false, cap: '<b>Fresh PS5 stock!</b> MRP pe seedha dukaan se — koi delivery fee nahi.' },
  ];
  return `
  <div class="b-scroll">
    ...
    <div style="background:var(--b-tint);padding:11px 16px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #FFE0D4">
      <div style="display:flex;align-items:center;gap:8px;min-width:0">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--b-magenta-ink)" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
    ...
    <div style="padding:6px 16px 10px;display:flex;align-items:center;justify-content:space-between;gap:12px">
      <div style="display:flex;padding:4px;border-radius:9999px;gap:2px;background:var(--b-surface)">
        ${['For you','Following','Saved'].map((t,i)=>`<button style="padding:8px 16px;border-radius:9999px;font-size:12px;font-weight:700;cursor:pointer;border:none;font-family:inherit;white-space:nowrap;${i===0?'background:var(--b-grad);color:var(--b-on-grad)':'background:transparent;color:var(--b-gray-2)'}">${t}</button>`).join('')}
      </div>
    ...
    <div class="b-head" style="background:var(--b-grad);padding:52px 16px 16px">
      ...
      <div style="display:flex;gap:8px">
        ...
        <button style="width:46px;height:46px;border-radius:12px;border:none;background:#fff;display:flex;align-items:center;justify-content:center">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--b-orange)" stroke-width="2" stroke-linecap="round"><line x1="4" y1="21" x2="4" y2="14"/><line x1="4" y1="10" x2="4" y2="3"/><line x1="12" y1="21" x2="12" y2="12"/><line x1="12" y1="8" x2="12" y2="3"/><line x1="20" y1="21" x2="20" y2="16"/><line x1="20" y1="12" x2="20" y2="3"/><line x1="1" y1="14" x2="7" y2="14"/><line x1="9" y1="8" x2="15" y2="8"/><line x1="17" y1="16" x2="23" y2="16"/></svg>
        </button>
      </div>
    </div>
    ...
    <div style="padding:0 20px;margin-top:-42px;position:relative">
      ...
      <div style="display:flex;align-items:flex-end;justify-content:space-between;margin-bottom:16px">
        ...
        <span style="display:inline-flex;align-items:center;gap:5px;padding:7px 12px;border-radius:9999px;background:#fff;border:1px solid var(--b-line);font-size:11px;font-weight:700;margin-bottom:8px">
          <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="var(--b-magenta-ink)" stroke-width="2.2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg> 1.6 km away
        </span>
      </div>
      <!-- Name + stars -->
