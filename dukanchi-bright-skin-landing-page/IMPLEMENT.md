...
| `landing.html` + `assets/` | **Marketing landing page** (yellow skin, Hinglish, AI-search showcase, Ask Nearby, Online-vs-Offline, news proof). Source file. |
| `landing-standalone.html` | **Deploy-ready** single self-contained file (fonts + image inlined) — host it directly as the dukanchi.com replacement. |
