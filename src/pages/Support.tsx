      ...
      <div className="flex bg-white border-b border-gray-100 sticky top-[61px] z-10">
        <button 
          ...
          className={`flex-1 px-4 py-3 text-sm font-medium text-center border-b-2 transition-colors flex justify-center items-center ${
            activeTab === 'help' ? 'border-[#C77E00] text-[#C77E00]' : 'border-transparent text-gray-500 hover:text-gray-700'
          }`}
        >
      ...
      <main className="p-4">
        {activeTab === 'help' && (
          <div className="space-y-6">
            <div className="bg-[#FFF6DD] p-6 rounded-2xl flex flex-col items-center text-center">
              <Mail className="h-10 w-10 text-[#C77E00] mb-3" />
              ...
              <a
                ...
                className="bg-[#C77E00] text-white font-medium py-2 px-6 rounded-full w-full text-center block"
              >
                Email Support
              </a>
            </div>
