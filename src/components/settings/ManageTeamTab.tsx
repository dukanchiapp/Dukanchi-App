  ...
  return (
    <div className="space-y-4">
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 flex items-center space-x-3">
        <div className="w-10 h-10 bg-[#C77E00] rounded-full flex items-center justify-center text-white font-bold text-sm">{ownerName?.charAt(0) || 'O'}</div>
        <div className="flex-1">
          <h3 className="font-semibold text-sm text-gray-900">{ownerName}</h3>
          <p className="text-xs text-gray-500">{ownerEmail}</p>
        </div>
        <span className="text-[10px] bg-[#FFF6DD] text-[#C77E00] px-2 py-0.5 rounded-full font-bold">Owner</span>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          {teamMembers.length < 3 ? (
            <button onClick={onToggleAddForm} className="text-xs font-semibold text-[#C77E00] bg-[#FFF6DD] px-3 py-1.5 rounded-lg flex items-center hover:bg-[#FFF6DD] transition-colors">
            ...
            <form onSubmit={(e) => { e.preventDefault(); onAddMember(); }} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:border-[#C77E00] focus:ring-2 focus:ring-[#FFE6B3] transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 p-3 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:border-[#C77E00] focus:ring-2 focus:ring-[#FFE6B3] transition-all"
              ...
              <div className="flex space-x-3 pt-2">
                ...
                <button type="submit" className="flex-1 py-2.5 rounded-xl font-medium text-sm text-white bg-[#C77E00] hover:bg-[#A86A00] transition-colors">Add Member</button>
              </div>
            </form>
          </div>
        </div>
